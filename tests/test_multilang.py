"""Tests for Go, Rust, Java, C, C++, Ruby, PHP, Kotlin, Swift, Solidity, and Vue parsing."""
...
class TestPHPTestAnnotations:
    ...
    methods were misclassified as production ``Function`` nodes. PHP
    attributes need their own capture path (``attribute_list >
    attribute_group > attribute``), and the docblock tag needs a separate
