...
Supported: Python, JavaScript/TypeScript/TSX, Rust, C/C++, shell scripts, Verilog/SystemVerilog, Ansible playbooks/roles/tasks, Astro files parsed through the TypeScript parser, and Jupyter/Databricks notebooks. Generic YAML is not treated as source code.
