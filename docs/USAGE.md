...
The parser currently covers Python, JavaScript, TypeScript/TSX, Go, Rust, C/C++, shell scripts, Zig, ReScript, Nix, Verilog/SystemVerilog, Vue single-file components, Astro files parsed through the TypeScript parser, and Jupyter/Databricks notebooks (`.ipynb`).
