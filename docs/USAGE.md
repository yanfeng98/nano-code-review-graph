...
The parser currently covers Python, JavaScript, TypeScript/TSX, Rust, C/C++, shell scripts, Verilog/SystemVerilog, Vue single-file components, Astro files parsed through the TypeScript parser, and Jupyter/Databricks notebooks (`.ipynb`).
