...
- **Broad parser surface**: Python, JavaScript/TypeScript/TSX, Go, Rust, C/C++, shell scripts, Zig, Julia, ReScript, Nix, Verilog/SystemVerilog, Ansible playbooks/roles/tasks, Vue SFCs, Astro files parsed through the TypeScript parser, and Jupyter/Databricks notebooks. Generic YAML is not treated as source code.
